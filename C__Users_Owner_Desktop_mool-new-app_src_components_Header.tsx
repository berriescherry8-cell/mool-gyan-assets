...
function SidebarNavMobile() {
  ...
  const isAdmin = user && user.email === 'sharmadevendra715@gmail.com';
     ...
     <nav className="flex h-full flex-col">
      ...
      <div className="flex-1 overflow-auto py-2">
       ...
       <div className="mt-auto p-4 border-t border-white/10">
          {isUserLoading ? <Skeleton className="h-8 w-full" /> : (
            isAdmin && auth ? (
               <Button variant="outline" size="sm" className="w-full" onClick={() => auth.signOut()}>
